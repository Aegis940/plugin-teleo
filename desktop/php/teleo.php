...
?>
	...
	<div class="form-group">
	 ...
	 <div class="form-group">
		 <label class="col-sm-3 control-label help" data-help="{{Cocher la case si la connexion au site Veolia est faite depuis cette machine}}">{{Connexion au site Veolia}}</label>
		 <div class="col-sm-3">
	...
	<div class="form-group">
	 ...
	 <div class="form-group">
		 <label class="col-sm-3 control-label help" data-help="{{Cocher la case pour utiliser le template de widget aux couleurs du compteur Teleo}}">{{Template de widget}}</label>
		 <div class="col-sm-3">

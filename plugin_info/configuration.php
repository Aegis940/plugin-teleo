...
<form class="form-horizontal">
   ...
   <div class="form-group">
    <label class="col-lg-4 control-label" title="Afin de ne pas surcharger les serveurs Veolia, les données sont vérifiées une fois par heure à une minute aléatoire">{{Récupération des données à la minute}}</label>
    <div class="col-lg-4">
